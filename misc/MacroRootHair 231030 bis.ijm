...
/// Parameter setup
minsize=140; /// Minimum size for Root hair detection
MedianFilt=10; /// Mean filtering size for Main root segmentatioon
bck=200; /// Rolling background size
TopHat=5; /// TopHat filter size for Root hair segmentation
ratio=1.2; /// Ratio between Mean Main Root fluo / Root haur fluorescence (For In focus vs Out of Focus selection) 
